/*
  ...
  - The values [reopen_approved] on the enum `Status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Status_new" AS ENUM ('draft', 'pending', 'approved', 'rejected', 'deleted', 'closed', 'published', 'reopened', 'approval_requested', 'edit_requested', 'publish_requested', 'approval_rejected', 'edit_rejected', 'publish_rejected', 'edit_approved', 'publish_approved', 'reopen_requested', 'reopen_rejected', 'reopen_publish_requested', 'reopen_publish_rejected');
